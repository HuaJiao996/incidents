...
**关联 Incident Types Tab:**

```text
+----------------------------------------------------------------------+
| **关联 Incident Types:** [管理]                                        |
| +----+----------+---------------------+------------+                   |
...
| | ID | Name     | Description         | CreatedAt  | 操作            | |
| +----+----------+---------------------+------------+-----------------+ |
| | 1  | TypeA    | Default type        | 2023-10-27 | [查看/编辑][删除]| |
| | 2  | TypeB    | Critical type       | 2023-10-27 | [查看/编辑][删除]| |
| | ...                                                                  | |
+----------------------------------------------------------------------+
| [分页] << < 1 > >>                                                   |
+----------------------------------------------------------------------+
