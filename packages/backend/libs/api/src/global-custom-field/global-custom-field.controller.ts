...
export class GlobalCustomFieldController {
  constructor(private readonly globalCustomFieldService: GlobalCustomFieldService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateGlobalCustomFieldDto: UpdateGlobalCustomFieldDto) {
    return this.globalCustomFieldService.update(+id, updateGlobalCustomFieldDto);
  }
